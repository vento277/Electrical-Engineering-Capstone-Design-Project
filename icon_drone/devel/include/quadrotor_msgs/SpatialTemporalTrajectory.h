...
struct SpatialTemporalTrajectory_
{
  ...
  _coef_z_type coef_z;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _range_type;
  _range_type range;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::SpatialTemporalTrajectory_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.K.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.K[i]);
    }
    if (v.K.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.a.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.a[i]);
    }
    if (v.a.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.b.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.b[i]);
    }
    if (v.b.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.time_acc.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.time_acc[i]);
    }
    if (v.time_acc.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.range.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.range[i]);
    }
    if (v.range.empty() || true)
      s << "]";
    if (true || !indent.empty())
